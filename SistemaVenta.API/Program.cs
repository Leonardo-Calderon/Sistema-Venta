...
try
{
    ...
    // 1. Agregar servicios b�sicos para la API
    builder.Services.AddControllers();
    builder.Services.AddEndpointsApiExplorer();
    builder.Services.AddSwaggerGen();

    // 2. Configurar la Inyecci�n de Dependencias de tus proyectos
    ...
    // A�adimos esto para el endpoint de descarga de PDF que creamos
    ...
    // 4. Configurar la autenticaci�n con JWT
...
{
    // Si algo falla durante el arranque, lo capturamos aqu�
    Console.ForegroundColor = ConsoleColor.Red;
    Console.WriteLine("!!!!!!!!!! ERROR FATAL AL INICIAR LA APLICACI�N !!!!!!!!!!");
